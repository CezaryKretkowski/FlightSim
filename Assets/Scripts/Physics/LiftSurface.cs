...
{
    [SerializeField] SurfaceSpec config = null;
    ...
    public BiVector3 CalculateForces(Vector3 worldAirVelocity, Vector3 relativePosition)
    {
        BiVector3 forceTorque = new BiVector3();
        if (!gameObject.activeInHierarchy || config == null) return forceTorque;
        ...
        float dynamicPressure = 0.5f * 1.2f * airVelocity.sqrMagnitude;
        ...
        forceTorque.q += Vector3.Cross(relativePosition, forceTorque.p);
